...
"Copyright &copy; 2011-YYYY The 42 developers"));
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About 42", 0));
        label->setText(QApplication::translate("AboutDialog", "<b>42</b> version", 0));
