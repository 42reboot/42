...
int main(int argc, char *argv[])
{
    ...
    QApplication::setOrganizationName("42");
    QApplication::setOrganizationDomain("42.io");
    if(GetBoolArg("-testnet")) // Separate UI settings for testnet
        QApplication::setApplicationName("42-Qt-testnet");
    else
        QApplication::setApplicationName("42-Qt");
